            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if (Auth::user())
                        <a href="{{ url('/admin/employers/create') }}" title="Create">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Create</button>
                        </a>
                        @endif
                        <br/>
                        <br/>
                            ...
                            <table class="table">
                                ...
                                @foreach($employers as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if (Auth::user() && $item->company_id==Auth::user()->company_id )
